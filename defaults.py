...
OSCAR_SHOP_NAME = 'Comfy Homey'
OSCAR_SHOP_TAGLINE = 'Interior Inspiration'
...
OSCAR_DASHBOARD_NAVIGATION = [
    {
        ...
        #'access_fn': lambda user, url_name, url_args, url_kwargs: user.company.is_vendor,
    },
    {
        'label': _('Catalogue'),
        'icon': 'icon-sitemap',
    ...
    },
    {
        ...
        'children': [
            ...
            {
                'label':_('Vendors'),
                'url_name': 'dashboard:vendor-list',				
            },			
            #{
