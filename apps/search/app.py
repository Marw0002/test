...
class SearchApplication(Application):
    ...
    searchvendor_view = get_class('search.views', 'FacetedSearchVendorView')
    search_form = get_class('search.forms', 'SearchForm')
    search_form2 = get_class('search.forms', 'SearchForm2')	
    ...
    def get_urls(self):
        ...
        urlpatterns = [
            url(r'^$', search_view_factory(
                ...
                name='search'),
            url(r'^vendor/$', search_view_factory(
                view_class=self.searchvendor_view,
                form_class=self.search_form2,
                searchqueryset=self.get_sqs()),
                name='search-vendor')
        ]
