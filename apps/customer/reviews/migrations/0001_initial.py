...
import oscar.apps.customer.reviews.utils
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(choices=[(0, 'Requires moderation'), (1, 'Approved'), (2, 'Rejected')], default=oscar.apps.customer.reviews.utils.get_default_review_status, verbose_name='Status')),
                ...
                ('company', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='customer.Company')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(auto_now_add=True)),
                ('review', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='votes', to='reviews.VendorReview')),
