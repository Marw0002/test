...
from oscar.apps.customer.reviews.managers import VendorReviewQuerySet
from oscar.apps.customer.reviews.utils import get_default_review_status
from oscar.core import validators
from oscar.core.compat import AUTH_USER_MODEL, user_is_authenticated


@python_2_unicode_compatible
class AbstractVendorReview(models.Model):
    """
    ...
    company = models.ForeignKey(
        'customer.Company', related_name='reviews', null=True,
    ...
    title = models.CharField(
        verbose_name=pgettext_lazy(u"Vendor review title", u"Title"),
    ...
    def get_absolute_url(self):
        ...
        return reverse('customer:reviews-detail', kwargs=kwargs)
    ...
    def save(self, *args, **kwargs):
        super(AbstractVendorReview, self).save(*args, **kwargs)
        self.company.update_rating()

    def delete(self, *args, **kwargs):
        super(AbstractVendorReview, self).delete(*args, **kwargs)
