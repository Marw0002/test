...
from oscar.apps.messages.models import Message
from oscar.apps.messages.forms import ComposeForm
from oscar.apps.messages.utils import format_quote, get_user_model, get_username_field
